...
Access requires a ChatGPT account. If you have access, this is the recommended on-ramp before diving into the documentation or source code.
...
See the `laser-mcp README <https://github.com/InstituteforDiseaseModeling/laser-mcp/blob/main/README.md>`_ for setup instructions.
