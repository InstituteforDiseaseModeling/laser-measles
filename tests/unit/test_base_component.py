...
class ComponentWithDocstring(BaseComponent):
    """
...
class ComponentWithoutDocstring(BaseComponent):
    def __call__(self, model, tick: int) -> None:
        return None
...
class TestBaseComponent:
    ...
    def test_str_method_child_class_with_docstring(self):
        ...
        model = MockModel()
        component = ComponentWithDocstring(model)
    ...
    def test_str_method_child_class_without_docstring(self):
        ...
        model = MockModel()
        component = ComponentWithoutDocstring(model)
